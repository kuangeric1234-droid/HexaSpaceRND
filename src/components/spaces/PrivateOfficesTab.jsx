      ...
      <div className="bg-white border border-gray-200 rounded-md overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              {['Suite', 'Level', 'Pax', 'Placement', 'Rate', 'Occupant', 'Salto doors', 'Status', ''].map((h) => (
          ...
          <tbody>
            {sorted.length === 0 && (
              <tr><td colSpan={9} className="px-4 py-12 text-center text-gray-400 text-sm">No private offices yet.</td></tr>
            )}
            {sorted.map((o) => {
